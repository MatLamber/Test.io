...
namespace MoreMountains.TopDownEngine
{
    ...
    /// </summary>
    [AddComponentMenu("TopDown Engine/Weapons/MultiProjectileWeapon")]
    public class MultiProjectileWeapon : Weapon, MMEventListener<TopDownEngineEvent>
    {
        ...
        public override void WeaponUse()
        {
            ...
            List<Vector3> spawnPositions = DetermineAllSpawnPositions();
        ...
        /// <summary>
        /// Determines all spawn positions based on the spawn offset and whether or not the weapon is flipped
        /// </summary>
        public virtual List<Vector3> DetermineAllSpawnPositions()
        {
        ...
        {
            DetermineAllSpawnPositions ();

            Gizmos.color = Color.white;
            foreach (var spawnPosition in DetermineAllSpawnPositions())
            {
